...
class JobCardSystem {
    ...
    async fetchNextJobNumber() {
        try {
            const response = await fetch('https://a48af46286b337f6-223-233-87-122.serveousercontent.com/api/jobcards/next-number');
        ...
        this.customerSearchTimeout = setTimeout(async () => {
            try {
                const response = await fetch(
                    `https://a48af46286b337f6-223-233-87-122.serveousercontent.com/api/customers/search?q=${encodeURIComponent(query)}`
                );
    ...
    async handleShipperSearch(event) {
        ...
        this.shipperSearchTimeout = setTimeout(async () => {
            try {
                const response = await fetch(
                    `https://a48af46286b337f6-223-233-87-122.serveousercontent.com/api/shippers/search?q=${encodeURIComponent(query)}`
                );
