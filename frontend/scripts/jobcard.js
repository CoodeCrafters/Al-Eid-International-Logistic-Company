...
async function fetchNextJobNumber() {
    try {
        ...
        const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/next-number?mode=${mode}&type=${type}`);
...
async function checkJobNumberExists(jobNumber) {
    try {
        const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/check-number?jobNo=${encodeURIComponent(jobNumber)}`);
        const data = await response.json();
...
function setupEnhancedCustomerAutocomplete(inputField) {
    ...
    inputField.addEventListener('input', function(e) {
        ...
        timeout = setTimeout(async () => {
            try {
                const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/customers/search?q=${encodeURIComponent(query)}`);
                if (response.ok) {
...
function setupEnhancedShipperAutocomplete(inputField) {
    ...
    inputField.addEventListener('input', function(e) {
        ...
        timeout = setTimeout(async () => {
            try {
                const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/shippers/search?q=${encodeURIComponent(query)}`);
                if (response.ok) {
...
function setupEnhancedRequesterAutocomplete(inputField) {
    ...
    inputField.addEventListener('input', function(e) {
        ...
        timeout = setTimeout(async () => {
            try {
                const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/requesters/search?q=${encodeURIComponent(query)}`);
                if (response.ok) {
...
async function saveJobCard() {
    ...
    try {
        const response = await fetch('https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/save-draft', {
            method: 'POST',
            headers: {
...
async function handleJobCardSubmit(event) {
    ...
    try {
        const response = await fetch('https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/submit', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function generateInvoice() {
    ...
    try {
        const response = await fetch('https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/generate-invoice', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
function printJobCard(jobNumber) {
    ...
    window.print();
        ...
        async function generateInvoiceFromSuccess(jobNumber) {
            try {
                const response = await fetch(`https://before-approach-rubber-liabilities.trycloudflare.com/api/jobcards/${jobNumber}/invoice`);
                if (response.ok) {
                    const result = await response.json();
                    sessionStorage.setItem('invoiceData', JSON.stringify(result));
                    window.location.href = 'invoice-generator.html';
...
async function updateStats() {
    try {
        const response = await fetch('https://before-approach-rubber-liabilities.trycloudflare.com/api/stats/jobcards');
        if (response.ok) {
