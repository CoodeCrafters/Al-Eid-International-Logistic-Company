...
static getApiBaseUrl() {
    ...
    return 'https://ball-sent-epinions-protective.trycloudflare.com/api';
}
...
static async checkDatabaseConnection() {
    try {
        ...
        const url = `https://ball-sent-epinions-protective.trycloudflare.com/api/health?t=${timestamp}`;
...
static updateDatabaseStatus(isOnline, errorMessage = '') {
    ...
    static async fetchJobCardData(endpoint, data = null) {
        const url = `https://ball-sent-epinions-protective.trycloudflare.com${endpoint}`;
